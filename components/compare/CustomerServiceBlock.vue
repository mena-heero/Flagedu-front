        ...
        <div class="rating">
          <i
            v-for="(rate, ridx) in totalFullStar(
              companyDetail.company1.customer_service_rating
            )"
            :key="'ratef_' + ridx"
    ...
    <div class="company-content-item">
      <div class="overall-score" v-if="companyDetail.company2">
        ...
        <div class="rating">
          <i
            v-for="(rate, ridx) in totalFullStar(
              companyDetail.company2.customer_service_rating
            )"
            :key="'ratef_' + ridx"
            class="bi bi-star-fill rating-color"
          ></i>
    ...
    <div class="company-content-item">
      <div class="overall-score" v-if="companyDetail.company3">
        ...
        <div class="rating">
          <i
            v-for="(rate, ridx) in totalFullStar(
              companyDetail.company3.customer_service_rating
            )"
            :key="'ratef_' + ridx"
            class="bi bi-star-fill rating-color"
          ></i>
    ...
    <div class="company-content-item">
      <div class="overall-score" v-if="companyDetail.company4">
        ...
        <div class="rating">
          <i
            v-for="(rate, ridx) in totalFullStar(
              companyDetail.company4.customer_service_rating
            )"
            :key="'ratef_' + ridx"
            class="bi bi-star-fill rating-color"
          ></i>
...
export default class CustomerServiceBlock extends Vue {
  @Prop() companyDetail;
