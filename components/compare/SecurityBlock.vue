  ...
  <div class="company-content">
    <div class="company-content-item">
      <div class="overall-score" v-if="companyDetail.company1">
        <div class="title">درجة الأمان</div>
        <div class="rating">
          <i
            v-for="(rate, ridx) in totalFullStar(
              companyDetail.company1.security_rating
            )"
            :key="'ratef_' + ridx"
    ...
    <div class="company-content-item">
      <div class="overall-score" v-if="companyDetail.company2">
        ...
        <div class="rating">
          <i
            v-for="(rate, ridx) in totalFullStar(
              companyDetail.company2.security_rating
            )"
            :key="'ratef_' + ridx"
            class="bi bi-star-fill rating-color"
          ></i>
    ...
    <div class="company-content-item">
      <div class="overall-score" v-if="companyDetail.company3">
        ...
        <div class="rating">
          <i
            v-for="(rate, ridx) in totalFullStar(
              companyDetail.company3.security_rating
            )"
            :key="'ratef_' + ridx"
            class="bi bi-star-fill rating-color"
          ></i>
    ...
    <div class="company-content-item">
      <div class="overall-score" v-if="companyDetail.company4">
        ...
        <div class="rating">
          <i
            v-for="(rate, ridx) in totalFullStar(
              companyDetail.company4.security_rating
            )"
            :key="'ratef_' + ridx"
            class="bi bi-star-fill rating-color"
          ></i>
